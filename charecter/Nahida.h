...
Nahida::Nahida(){
    ...
    NahidaTalk = {
        ...
        {   
            ".............................",
            "Nahida : ฮึก (*′☉.̫☉) !!! ",
            "Nahida : เลิกยุ่งกับฉันทีเถอะ (,,Ծ‸Ծ,, ) "
        },
        
        // วันที่ 2
        {   
            "Nahida : //ซากุระพึ่งตื่นนอนแบบงัวเงีย หลังจากลืมตาขึ้นมาก็เจอกับคุณ",
            "Nahida : อืม ฉันตื่นเพราะคุณนั่นแหละ คุณมาที่นี่ทำไม",
            "Nahida : ขอบคุณนะ ..."
        },
        
        // วันที่ 3
        {   
            "Nahida :วันนี้ฉันต้องไปรับการพิพากษาแล้วสินะ.",
            "Nahida :( ◜◒◝ )♡ ง่วงจังง",
            "Nahida : ฉันจะโดนประหารไหม (ซากุระทำหน้ากังวล)"
        },
        
        // วันที่ 4
        {   
            "//เมื่อคุณมาถึงพบว่า Nahida กำลังหลับอยู่",
            "//ซากุระหันหน้าขึ้นมามองคุณด้วยสายตาที่เหมือนกับลูกหมาที่กำลังร้องไห้",
            "Nahida :วันพรุ่งนี้ คุณจะยังมาหาฉันไหม"
        },
        
        // วันที่ 5
        {   
            "Nahida : //ซากุระตั้งตารอเพื่อที่จะได้พบคุณ",
            "Nahida : ฉันสบายดี ไม่มีคุณฉันก็ยังหายใจได้เหมือนเดิม",
        ...
        {   
            ...
            "Nahida : คุณไปทำอะไรมา ",  
            "Nahida : ฉันไม่อยากให้ถึงวันพรุ่งนี้เลย"
        },
        
        // วันที่ 7
        {   
            "(ในที่สุดก็ถึงวันประหารซากุระ)",
            "Nahida : วันนี้คือวันสุดท้ายของฉันแล้ว",
            "ซากุระร้องไห้"
        }
    };
