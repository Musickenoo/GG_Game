...
Sakura::Sakura(){
    ...
    SakuraQuestions = {
        ...
        {   "Sakura : คุณใจดีจัง ",
            ...
            "Sakura ://ซากุระหน้ามืดคล้ายจะเป็นลม คุณเดินเข้าไปใกล้ซากุระ จากนั้นซากุระถามคุณว่า\n คุณจะพาฉันไปไหน "
        },
    ...
    SakuraAction = {
        // วันแรก
        {
            {"Sakura :ฉันรู้อยู่แล้วแหละน่า!!","Sakura : (;´༎ຶٹ༎ຶ`)","Sakura : ขอบคุณนะ "},
            {"Sakura :อือ ... ","Sakura :ฉันอยากกลับบ้านจัง ","Sakura : เขิน "},
            {"Sakura :ขอบคุณนะ", "Sakura :อยู่คุยกันก่อนสิ ", "Sakura : ฉันไม่ได้อยากพูดกับเธอหรอกนะ "}
        },
        ...
        // วันที่สี่
        {
            ...
            {"Sakura :เพราะฉันโดนใส่ร้ายว่าเป็นฆาตกร ทั้งๆที่ฉันยังไม่ได้ทำอะไรผิดเลย\n แต่คนอื่นกลับเชื่อว่าฉันฆ่าคน ", "Sakura :อย่าปากแข็งได้ไหม ถ้าอยากรู้ ก็บอกว่าอยากรู้สิ", "Sakura :เพราะฉันโดนใส่ร้ายว่าเป็นฆาตกร ทั้งๆที่ฉันยังไม่ได้ทำอะไรผิดเลย \nแต่คนอื่นกลับเชื่อว่าฉันฆ่าคน"},
