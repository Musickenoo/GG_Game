...
Venti::Venti() {
    ...
    Ending = {
        "แย่ คุณทำใจยอมรับเรื่องราวที่เกิดขึ้นตรงหน้าคุณไม่สามารถช่วยเวนติ\nจากการถูกประหารได้ และเขาก็สิ้นใจต่อหน้าคุณ",
        "ดี คุณยอมเป็นศัตรูกับคนทั้งโลก เพื่อให้เวนติอยู่กับคุณตลอดไป",
        "ดีมาก คุณหยุดการพิพากษาได้และคุณได้ใช้ชีวิตอย่างสงบสุขกับเวนติ"
    };
}
